...
public class MusicUtils {
     ...
     */
    @NonNull
    public static List<LocalMusic> scanMusic(Context context) {
        List<LocalMusic> musicList = new ArrayList<>();

        long filterSize = ParseUtils.parseLong(SPTool.getSharedPreferences().getString(ConstantTools.FILTER_SIZE, "0")) * 1024;
        long filterTime = ParseUtils.parseLong(SPTool.getSharedPreferences().getString(ConstantTools.FILTER_TIME, "0")) * 1000;
