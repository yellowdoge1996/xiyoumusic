...
public class ConstantTools {
    public static final String baseUrl1 = "http://192.168.1.174:8080/";
    public static final String baseUrl2 = "http://192.168.43.126:8080/";

    public static final String baseUrl = baseUrl2;

    public static final String authority = "com.xiyoumusic.app.fileprovider";

    public static final String FILTER_SIZE = "filter_size";
    public static final String FILTER_TIME = "filter_time";

    public static final String EXTRA_NOTIFICATION = "com.xiyoumusic.app.notification";
    ...
    public static final String ACTION_STOP = "com.xiyoumusic.app.ACTION_STOP";
    ...
    public static final String TYPE_ONLINE_MUSIC = "online_music";
/******************** 存储相关常量 ********************/
    /**
     * Byte与Byte的倍数
     */
